...
<%
    ...
    // 2. 로그인 체크 (세션 확인 - 우리가 만든 보안 로직)
    // 임시 코드(elon_musk)는 제거하고 실제 세션값 사용
...
<%
    ...
    if (tab == null) tab = "ALL"; // 기본값

    // 4. 데이터 가져오기 (DAO 호출)
    PostDAO dao = new PostDAO();
    ArrayList<post> list = dao.getTimeline(myId, tab); // 게시글 목록
    
    CommentDAO commentDao = new CommentDAO(); // 댓글/대댓글 처리를 위한 DAO
%>
...
<body>
    ...
    <div class="header">
        <div class="header-left">
            ...
            <div class="nav-menu">
                ...
                <a href="message_inbox.jsp" class="nav-item"><span>💬</span> 쪽지</a> <a href="#" class="nav-item" onclick="alert('준비중')"><span>👥</span> 그룹</a>
            </div>
        </div>
        <div class="header-right" onclick="location.href='mypage.jsp?id=<%=myId%>'"> <div class="my-profile-img"></div>
    ...
    <div class="container">
        ...
        <% } else { %>
            ...
            %>
            <div class="post-item">
                <div class="my-profile-img"></div> <div class="post-content">
